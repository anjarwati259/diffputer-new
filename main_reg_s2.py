...
# Import dari dataset_reg_s2_sigmoid_minmax.py
# =============================================================================
...
from dataset_reg_s2 import (load_dataset, get_eval, mean_std,
...
if __name__ == '__main__':
    ...
    for iteration in range(args.max_iter):
        ...
        with open(f'{result_save_path}/result_reg_s2_sigmoid_minmax.txt', 'a+') as f:
            f.write(
